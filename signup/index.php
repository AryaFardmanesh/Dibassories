...
<body>
	<div class="login-card my-4">
		...
		<form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="card" method="POST">
			<div class="card-body bg-white shadow rounded">
				<h5 class="mb-4 mt-1 fw-bold fs-5 text-secondary">ایجاد حساب کاربری</h5>
				...
				<button type="submit" class="btn btn-info text-white w-100 mt-2">ثبت نام</button>

				<div class="footer-text">
					<span>حساب کاربری دارید؟</span>
					<a href="<?= BASE_URL ?>/login/" class="text-info">وارد شوید.</a>
				</div>
			</div>
		</form>
	</div>

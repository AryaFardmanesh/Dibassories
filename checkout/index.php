...
<body>
	...
	<div class="container my-5">
		<h3 class="fw-bold mb-4 text-center text-info">ثبت سفارش</h3>

		<div class="card border-0 mb-4">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-center mb-3">
					<h5 class="fw-bold text-info mb-0">سبد خرید شما</h5>
				</div>
				...
				<div class="border-top pt-3 mt-3 d-flex justify-content-between align-items-center">
					<span class="fw-bold text-info">جمع کل:</span>
		...
		<div class="card border-0 shadow-sm">
			<div class="card-body">
				<h5 class="fw-bold text-info mb-3">اطلاعات ارسال و پرداخت</h5>
				<form action="<?= BASE_URL . "/src/controllers/shopping.php" ?>" method="GET" class="needs-validation" novalidate>
					...
					<div class="row g-3">
						...
						<div class="col-12 text-center mt-4">
							<button type="submit" class="btn btn-info text-white w-100 px-5 py-2 fs-6">پرداخت و ثبت سفارش</button>
						</div>
					</div>
				</form>
			</div>

...
define('CONTROLLER_ACCOUNT_DOWNGRADE', 4);
define('CONTROLLER_ACCOUNT_SELLER_REQUEST', 5);
define('CONTROLLER_ACCOUNT_SELLER_ACCEPT', 6);
define('CONTROLLER_ACCOUNT_SELLER_REJECT', 7);

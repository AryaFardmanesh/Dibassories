...
define('CONTROLLER_ACCOUNT_UPDATE', 0);
define('CONTROLLER_ACCOUNT_BLOCK', 1);
define('CONTROLLER_ACCOUNT_UPGRADE', 2);
define('CONTROLLER_ACCOUNT_DOWNGRADE', 3);
define('CONTROLLER_ACCOUNT_SELLER_REQUEST', 4);
define('CONTROLLER_ACCOUNT_SELLER_ACCEPT', 5);
define('CONTROLLER_ACCOUNT_SELLER_REJECT', 6);

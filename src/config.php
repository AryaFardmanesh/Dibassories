...
define('CONTROLLER_ACCOUNT_UNBLOCK', 3);
define('CONTROLLER_ACCOUNT_REMOVE', 4);
define('CONTROLLER_ACCOUNT_UPGRADE', 5);
define('CONTROLLER_ACCOUNT_DOWNGRADE', 6);
define('CONTROLLER_ACCOUNT_SELLER_REQUEST', 7);
define('CONTROLLER_ACCOUNT_SELLER_ACCEPT', 8);
define('CONTROLLER_ACCOUNT_SELLER_REJECT', 9);
...
define('CONTROLLER_TRANSACTION_STATUS_PAID', 6);
define('CONTROLLER_TRANSACTION_STATUS_NOT_PAID', 7);
define('CONTROLLER_TRANSACTION_STATUS_SUSPENDED', 8);
define('CONTROLLER_TRANSACTION_STATUS_CONFIRM', 9);

define('TRANSACTION_TEST_CODE', 'XydL9');

define('CONTROLLER_ORDER_PURCHE', 1); // shopping.php

define('CONTROLLER_ORDER_STATUS_CONFIRM', 1); // order.php
define('CONTROLLER_ORDER_STATUS_OPEN'	, 2);
define('CONTROLLER_ORDER_STATUS_CLOSE', 3);
define('CONTROLLER_ORDER_STATUS_SENT', 4);
define('CONTROLLER_ORDER_STATUS_REMOVE', 5);
define('CONTROLLER_ORDER_STATUS_UPDATE', 6);

...
define('CONTROLLER_PRODUCT_SUSPEND', 1);
define('CONTROLLER_PRODUCT_REMOVE', 2);
define('CONTROLLER_PRODUCT_RESTORE', 3);
define('CONTROLLER_PRODUCT_ACCEPT', 4);
define('CONTROLLER_PRODUCT_REJECT', 5);
define('CONTROLLER_PRODUCT_INC', 6);
define('CONTROLLER_PRODUCT_DEC', 7);
